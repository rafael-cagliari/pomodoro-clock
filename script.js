...
// - [OK] FIX : + & - button > user cant change them while timer running 
// - FIX : Pressing Stop button twice > crazy numbers 
// - [OK]FIX : Pressing Pause button > crazy numbers (but when play is pressed it goes normal)
// - STYLING

/*

[+][-] > when PLAY (active) > [+-] (inactive) 
